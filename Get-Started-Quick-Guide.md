...
2. Make sure you can execute a JAR file by double-clicking the file. If not, check that [Java](http://www.java.com) is installed properly and the environment variables are setup correctly.
