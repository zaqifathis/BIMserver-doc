...
_Note: This documentation is for BIMserver > 1.2_
...
For every call you should send an HTTP POST request to http://[address+port]/json. The body of this request should be an UTF-8 encoded JSON message. The structure of this message is the following:
{{{
{
